...
interface ContestConfig { id: string; name: string; examDate: string; targetMinutes: number; targetAccuracy: number; specificWeight: number; generalWeight: number; minQuestions: number; updatedAt: string; }
...
const DEFAULT_CONTEST: ContestConfig = { id: 'dataprev-2026', name: 'Dataprev 2026 — Desenvolvedor de Software', examDate: '2026-10-11', targetMinutes: DEFAULT_TARGET, targetAccuracy: 100, specificWeight: 2.5, generalWeight: 1, minQuestions: MIN_SAMPLE, updatedAt: new Date().toISOString() };
